...
$database_table = "test_guests"; // name of database table to read/write
$app_title = 'TT284 Block 2 - CRUD App (Iteration B)';
$css_file = "c_admin.css"; // name of CSS file to load
$js_file = "c_admin.js"; // name of JavaScript file to load
...
require "c_read-columns.php";
// Read the submitted form data into $data
require 'c_read-post.php';
